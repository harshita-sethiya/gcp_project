...
const service_object_1 = require("./common-grpc/service-object");
 ...
 */
class Database extends service_object_1.GrpcServiceObject {
    ...
    runStream(query, options) {
        ...
        this.pool_.getReadSession((err, session) => {
            ...
            dataStream
                ...
                .once('error', err => {
                if (!dataReceived && session_pool_1.isSessionNotFoundError(err)) {
