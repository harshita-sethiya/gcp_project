...
const operation_1 = require("./common-grpc/operation");
...
const grpc_gcp_1 = require("grpc-gcp");
...
class Spanner extends service_1.GrpcService {
    constructor(options) {
        ...
        options = Object.assign({
            ...
            'grpc.callInvocationTransformer': grpc_gcp_1.gcpCallInvocationTransformer,
            'grpc.channelFactoryOverride': grpc_gcp_1.gcpChannelFactoryOverride,
            'grpc.gcpApiConfig': grpc_gcp_1.createGcpApiConfig(gcpApiConfig),
            grpc,
        }, options || {});
    ...
    operation(name) {
        ...
        // tslint:disable-next-line no-any
        return new operation_1.GrpcOperation(this, name);
    }
    /**
