...
export declare type BatchUpdateResponse = [number[], s.ExecuteBatchDmlResponse];
...
export declare type RunResponse = [Rows, spannerClient.spanner.v1.ResultSetStats];
...
export interface RunCallback {
    (err: null | ServiceError, rows: Rows, stats: spannerClient.spanner.v1.ResultSetStats): void;
}
...
export declare class Transaction extends Dml {
     ...
     * });
     */
    constructor(session: Session, options?: s.ReadWrite, queryOptions?: IQueryOptions);
